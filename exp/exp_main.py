...
class Exp_train(Exp_Basic):
    ...
    def _get_data(self, flag, stock):
        data_set,_ = data_provider(self.args, flag, self.data_dict, stock)
    ...
    def train(self, setting):
        ...
        test_loader = DataLoader(test_data, batch_size=self.args.batch_size, shuffle=False, drop_last=False, num_workers = 10)
